...
def main():
    ...
    # its cause. The directory outlives both steps and is removed when the block
    # exits by returning, sys.exit or an exception (not when the process is
    # killed outright, e.g. by SIGKILL).
